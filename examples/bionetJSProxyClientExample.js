...
const fs = require('fs');
const BionetProxyClient = require('../src/BionetProxyClient')
const BionetApi = require('../src/api/BionetJSApi')
...
function run(_connection) {
    ...
    if (rpcBatch) {
        ...
        bionetApi.getLocationPathChildren("p-c08311d1-6e61-4648-8f75-e037edf0c8be", function(err,result){
            if (err) {
                console.log("getLocationPathChildren error:",err)
            } else {
                console.log("getLocationPathChildren result:"+JSON.stringify(result,null,2))
        ...
        bionetApi.get("p-c08311d1-6e61-4648-8f75-e037edf0c8be", function(err,result){
            if (err) {
        ...
        bionetApi.get("p-c08311d1-6e61-4648-8f75-e037edf0c8be_x", function(err,result){
            if (err) {
                console.log("get error:",err)
            } else {
                console.log("get result:"+JSON.stringify(result,null,2))
